...
const sections = () => [
  ['1. Service', <>We provide online courses  through our platform. The Service is provided 'as is' and 'as available' without any warranties of any kind. We reserve the right to modify, suspend, or discontinue the Service at any time without notice.</>],
  ...
  ['4. Support Services', <>Support is provided primarily via email and our dedicated support portal. You can contact {company.legalName} at <a href={supportMailto} className="font-bold text-coral">{company.supportEmail}</a>{' '}We strive to respond to all inquiries within 24-48 business hours.</>],
  ...
  ['11. Dispute Resolution', <><p>If you have a complaint or dispute regarding a purchase, charge, or your use of the services, you agree to first contact us at <a href={supportMailto} className="font-bold text-coral">{company.supportEmail}</a> so that we may attempt to resolve the matter directly. We aim to acknowledge complaints within 24 hours and to reach a resolution within 5 business days.</p><p className="mt-5">We encourage you to raise any billing concern with us directly before contacting your card issuer or payment provider, as doing so allows us to resolve the matter more quickly than a formal chargeback process.</p><p className="mt-5">If a dispute cannot be resolved directly between you and the Company within a reasonable timeframe, either party may refer the matter to an independent mediation or alternative dispute resolution service before pursuing formal legal proceedings.</p></>],
  ['12. Governing Law', <>These Terms, and any dispute or claim arising out of or in connection with them or the services provided through this website, shall be governed by and construed in accordance with the laws of {company.governingLawCountry}, without regard to its conflict of law provisions. The courts of {company.governingLawCountry} shall have exclusive jurisdiction to settle any such dispute, save as otherwise provided in the Dispute Resolution clause above.</>],
  ...
  ['19. General Provisions', <>These Terms shall be governed and construed in accordance with the laws of {company.governingLawCountry}, without regard to its conflict of law provisions. Our failure to enforce any right or provision of these Terms will not be considered a waiver of those rights.</>],
];
        ...
        <section className="shell py-10 md:py-16">
          <div className="mx-auto max-w-[900px] border-t-4 border-coral bg-white p-6 shadow-[0_20px_50px_rgba(23,27,25,0.08)] md:p-12">
            <div className="border-b border-ink/15 pb-8">
              ...
              <p className="mt-3 text-xl font-bold">Terms and conditions overview</p>
            ...
            <div className="divide-y divide-ink/15">
              {sections().map(([heading, content]) => <section key={heading} className="py-8 first:pt-8"><h2 className="text-lg font-bold">{heading}</h2><div className="mt-4 leading-7 text-ink/65">{content}</div></section>)}
            </div>
          </div>
        </section>
      </main>
