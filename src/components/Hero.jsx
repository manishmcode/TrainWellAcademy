...
export default function Hero() {
  return <section id="top" className="shell grid min-h-[700px] gap-x-10 gap-y-0 pt-14 lg:grid-cols-[.8fr_1.2fr] lg:items-center">
    ...
    <div className="relative h-[570px] overflow-hidden bg-ink"><img src="/assets/home/hero-fitness.webp" alt="Athlete preparing for a home workout" width="1100" height="570" fetchPriority="high" /><a href={getCourseAccessPath()} aria-label="Explore the featured fitness program" className="absolute left-1/2 top-1/2 grid size-20 -translate-x-1/2 -translate-y-1/2 place-items-center rounded-full bg-coral text-cream"><Play fill="currentColor" /></a><div className="absolute bottom-5 left-5 bg-cream p-4 pr-16"><small className="font-bold">FEATURED PROGRAM</small><h3 className="text-lg font-bold">Ultimate Home Workout Plan</h3><small>10 practical on-demand lessons</small></div></div>
