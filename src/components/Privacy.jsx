...
const sections = [
  ...
  ['9. Contact', <>Questions, comments, and requests regarding this Privacy Policy are welcomed and should be addressed to Zenaria Ltd, Str A15 Stadiou, 2867 Oikos, Nicosia, Cyprus, or by email at <a href="mailto:support@learntechlive.net" className="font-bold text-coral">support@learntechlive.net</a>.</>],
];
        ...
        <section className="shell py-10 md:py-16">
          <div className="mx-auto max-w-[900px] border-t-4 border-coral bg-white p-6 shadow-[0_20px_50px_rgba(23,27,25,0.08)] md:p-12">
            <div className="border-b border-ink/15 pb-8">
              ...
              <p className="mt-4 max-w-xl leading-7 text-ink/60">How Zenaria Ltd collects, uses, protects, and manages information when you use our Site and Services.</p>
              <p className="mt-5 text-sm text-ink/50">Last updated: September, 2026</p>
              <div className="mt-6 border-l-4 border-coral bg-cream p-5 text-sm leading-7 text-ink/65"><strong className="block text-ink">Controller details</strong><span className="block">Zenaria Ltd</span><span className="block">Str A15 Stadiou</span><span className="block">2867 Oikos</span><span className="block">Nicosia, Cyprus</span><a href="mailto:support@learntechlive.net" className="mt-2 inline-block font-bold text-coral">support@learntechlive.net</a></div>
            </div>
